...
To install `iguess` use the latest setup <a href="https://drive.google.com/open?id=1thkxr0x78PnCjXHW9yMgy8Fuf903bMFr">iguess[Updated].msi</a> file and follow the below steps
...
5) Wait! for the installation to **Complete** and Thats it..!, click **Close**.
...
4) If you are done with entering the feedback click **Save** to store in the DataBase and to evaluate the feedbacks.
**For Video guide** <a href="https://drive.google.com/open?id=1gOyxj26MMQOd4HdYtxvSds4fETFtsQsL">Click This Link</a>

## Editing feedbacks
If you made some mistakes while clicking the feedback you can use the **Previous** and **Next** buttons to edit the previously entred feedbacks for more details you can follow the video guide given below.
...
you can store the feedback just by clicking the **Save** button.
...
Thats it!, you can start again for more details video guide is below.
...
Here we can enter the principal's comment or feedback for that particular faculty and take **print** of the report.
...
4) If you are done time for some BAM!, just click **print**, for more details see the video guide.
